 ...
 */
@Component
@Path("/shipments/{shipmentId}/pick")
@Consumes({MediaType.APPLICATION_XML})
@Produces({MediaType.APPLICATION_XML})
public class ShipmentPickResource
{
	private static final Logger LOGGER = LoggerFactory.getLogger(ShipmentPickResource.class);
	 ...
	 * Pick shipment.
	 * 
	 * @param shipmentId the shipment id of the {@link Shipment} to be picked.
	 * @return the response with the picked shipment object embedded in it
	 */
	@POST
	...
	public Response pickShipment(@PathParam("shipmentId") final String shipmentId)
	{
		LOGGER.trace("pickShipment");
		final Shipment shipment = this.shipmentServices.pickShipment(shipmentId);
