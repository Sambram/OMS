...
/**
 * Unit test for {@link WholeOrderLineStrategy}.
 */
public class WholeOrderLineStrategyTest
{
	...
	private WholeOrderLineStrategy strategy;

	@Before
	public void setUp()
	{
		strategy = new WholeOrderLineStrategy();
	...
	@Test
	public void shouldSkipIfWholeOrderLineCannotBeAssigned()
	{
		final Map<String, List<SourcingLocation>> matrix = new HashMap<>();
