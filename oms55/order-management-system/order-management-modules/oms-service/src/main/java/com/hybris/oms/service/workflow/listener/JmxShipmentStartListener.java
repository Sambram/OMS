...
/**
 * Activiti {@link ExecutionListener} triggered when the shipment workflow starts.
 */
public class JmxShipmentStartListener implements ExecutionListener
{
	...
	{
		processMbean.incrementNumShipmentProcesses();
	}
