...
@AggregationPojo(name = "AggOrderLineQuantityBySkuStatus", typeCode = OrderLineQuantityData._TYPECODE, live = true, sendEvent = true, cronExpression = "0 0 0 * * ?")
public class AggOrderLineQuantityBySkuStatus implements AtsQuantityAggregate
{
