...
@AggregationPojo(name = "AggItemQuantityByItemIdStatus", typeCode = CurrentItemQuantityData._TYPECODE, live = true, sendEvent = true, cronExpression = "0 0 0 * * ?")
public class AggItemQuantityByItemIdStatus implements AtsQuantityAggregate
{
