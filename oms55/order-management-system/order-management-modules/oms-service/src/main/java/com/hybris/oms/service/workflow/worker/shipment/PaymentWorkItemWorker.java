 ...
 */
public class PaymentWorkItemWorker extends AbstractWorkItemWorker
{
	private static final Logger LOG = LoggerFactory.getLogger(PaymentWorkItemWorker.class);
	...
	protected void executeInternal(final Map<String, Object> parameters)
	{
		...
		LOG.debug("Starting shipment payment capture work item on shipment id: {}", shipmentId);
		...
		LOG.debug("Done shipment payment capture work item on shipment id: {}. Outcome: {}", shipmentId, Boolean.TRUE);
	}
