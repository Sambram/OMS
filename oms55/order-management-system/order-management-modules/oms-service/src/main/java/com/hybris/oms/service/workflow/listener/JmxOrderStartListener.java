...
/**
 * Activiti {@link ExecutionListener} triggered when the order workflow starts.
 */
public class JmxOrderStartListener implements ExecutionListener
{
	...
	{
		processMbean.incrementNumOrderProcesses();
	}
