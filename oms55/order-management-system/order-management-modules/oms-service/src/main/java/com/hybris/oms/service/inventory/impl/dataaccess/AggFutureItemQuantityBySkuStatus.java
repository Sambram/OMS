...
@AggregationPojo(name = "AggFutureItemQuantityBySkuStatus", typeCode = FutureItemQuantityData._TYPECODE, live = true, sendEvent = true, cronExpression = "0 0 0 * * ?")
public class AggFutureItemQuantityBySkuStatus implements AtsQuantityAggregate
{
	@Grouped(priority = 1, attribute = "owner.itemId")
	public String sku; // NOPMD

	@Grouped(priority = 2, attribute = "statusCode")
	public String statusCode; // NOPMD

	@Grouped(priority = 3, attribute = "expectedDeliveryDate")
