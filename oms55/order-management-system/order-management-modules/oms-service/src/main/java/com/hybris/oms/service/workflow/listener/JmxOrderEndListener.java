...
/**
 * Activiti {@link ExecutionListener} triggered when the order workflow ends.
 */
public class JmxOrderEndListener implements ExecutionListener
{
	...
	{
		processMbean.decrementRunningOrderProcesses();
	}
