...
public class CurrentInventoryAtsChangeTypecodeHandlerTest
{

	private static final String SKU = "ABC";

	@InjectMocks
	private final CurrentInventoryAtsChangeTypecodeHandler atsChangeTypecodeHandler = new CurrentInventoryAtsChangeTypecodeHandler();
	...
	public void setUp()
	{
		...
		when(persistenceManager.get(id)).thenReturn(itemLocationData);
	}

	@Test
	public void shouldGetSkuFromItemLocation() throws AtsChangeListenerException
	{
		// GIVEN
		final Map<String, Object> values = getValues();
		when(itemLocationData.getItemId()).thenReturn(SKU);
	...
	public void shouldNotFindSku_ManagedObjectNotFoundException() throws AtsChangeListenerException
	{
		// GIVEN
		final Map<String, Object> values = getValues();
		when(persistenceManager.get(id)).thenThrow(new ManagedObjectNotFoundException());
	...
	private Map<String, Object> getValues()
	{
		...
		map.put(ItemQuantityData.OWNER.name(), id);
		return map;
	}
}
